...
public class Controller {
  ...
  */
  ...
  public void handlerTerminate() throws Exception {
    ...
    //send meesage to Voting System to get the results back to the TrendAnalyzer
    KeyValueList kv = new KeyValueList();
    kv.putPair("Scope", SCOPE);
    kv.putPair("MessageType", "702");   //this message is to user for requesting report
    kv.putPair("Sender", NAME);
